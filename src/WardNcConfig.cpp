...
QString defaultColorsContents()
{
    return QStringLiteral(
        ...
        "    --card-bg: #151b24;\n"
        "    --card-border: #2a3344;\n"
        "    --summary-color: #eff4ff;\n"
        "    --body-color: #c9d3e4;\n"
        "    --app-name-color: #b3bfd5;\n"
        "    --timestamp-color: #8f9bb2;\n"
        "\n"
        "    --badge-bg: #253754;\n"
        "    --badge-color: #deebff;\n"
        "\n"
        "    --clear-bg: #263a58;\n"
        "    --clear-hover-bg: #31507a;\n"
        "    --clear-color: #edf4ff;\n"
        "\n"
        "    --dismiss-color: #d2d8e4;\n"
        "    --dismiss-hover-bg: #2d3442;\n"
        "\n"
        "    --action-bg: #2a3d5a;\n"
        "    --action-hover-bg: #35537f;\n"
        "    --action-color: #edf4ff;\n"
        "\n"
        "    --icon-bg: #1f2430;\n"
        "    --handle-bg: #2c3f60;\n"
        "\n"
        "    --scrollbar-track-bg: #192233;\n"
        "    --scrollbar-thumb-bg: #314966;\n"
        "    --scrollbar-thumb-hover-bg: #40628b;\n"
        "}\n");
}
...
QString defaultStyleContents()
{
    return QStringLiteral(
        ...
        "    --clear-radius: 8px;\n"
        "    --clear-size: 12px;\n"
        "    --clear-min-width: 86px;\n"
        "    --clear-padding-x: 16px;\n"
        "\n"
        "    --scrollbar-width: 8px;\n"
